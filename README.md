...
|User<br>Story| |Work-Item /Task| | | | | |
|ID|Title|ID|Title|Description|Estimation<br>(Hours)|Assigned<br>To|Status<br>(To-do <br>/InProcess<br>/ To-Review <br>/Done)|
| US44 | Autenticación de Usuarios con Multi-Factor (MFA) | *TA001* | Habilitar configuración de MFA | Configurar MFA para el inicio de sesión utilizando opciones como SMS o aplicaciones de autenticación. | 5 horas | José Alejo | Done |
| US45 | Roles y Permisos Basados en Roles de Usuario | *TA002* | Implementar control de acceso basado en roles | Configurar roles y permisos que permitan o restrinjan acceso a funcionalidades específicas según el rol del usuario. | 7 horas | Sebastian Calderon | Done |
| US46 | Gestión de Sesiones y Expiración Automática | *TA003* | Configurar cierre de sesión por inactividad | Implementar un sistema que cierre automáticamente la sesión tras un período de inactividad definido. | 4 horas | José Alejo | Done |
| US47 | Recuperación de Contraseña y Verificación de Identidad | *TA004* | Habilitar flujo de recuperación de contraseñas | Implementar un sistema de recuperación de contraseñas con envío de enlace seguro por correo electrónico tras la verificación de identidad. | 6 horas | Diego Rosado | Done |
| US48 | Auditoría de Inicios de Sesión | *TA005* | Crear registro de auditoría para inicios de sesión | Implementar un historial de inicio de sesión con información como fecha, hora y ubicación. | 5 horas | Estefano Jaque | Done |
| US49 | Bloqueo de Cuenta después de Intentos Fallidos | *TA006* | Configurar bloqueo tras intentos fallidos | Implementar un sistema que bloquee cuentas temporalmente tras un número determinado de intentos de inicio de sesión fallidos. | 4 horas | Sebastian Calderon | Done |
| US50 | Control de Acceso Basado en Atributos (ABAC) | *TA007* | Configurar permisos basados en atributos | Implementar permisos específicos según atributos como departamento o ubicación del usuario. | 7 horas | José Alejo | Done |
| US51 | Verificación de Email al Crear una Nueva Cuenta | *TA008* | Implementar verificación de email al registro | Implementar envío de correos de verificación al registrarse y activación de cuentas tras confirmación del correo. | 5 horas | Diego Rosado | Done |
| US52 | Delegación de Acceso Temporal | *TA009* | Habilitar delegación de acceso temporal | Permitir que los usuarios deleguen acceso limitado a otros usuarios durante un tiempo definido. | 6 horas | Sebastian Calderon | Done |
| US53 | Notificaciones de Seguridad en Tiempo Real | *TA010* | Configurar notificaciones de inicio de sesión sospechoso | Implementar sistema que notifique al usuario sobre actividades sospechosas en tiempo real. | 6 horas | Estefano Jaque | Done |
| US54 | Acceso Basado en el Principio de Menor Privilegio | *TA011* | Configurar permisos mínimos predeterminados | Implementar configuración de permisos mínimos necesarios según el principio de menor privilegio. | 4 horas | Diego Rosado | Done |
